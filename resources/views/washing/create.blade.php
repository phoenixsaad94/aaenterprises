            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.Add Washing')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'washings.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
...
$("table.order-list").on("click", ".edit-product", function() {
    ...
    width_units = temp_unit_name.slice(6, 8);
...
$('button[name="update_btn"]').on("click", function() {
    ...
    var position_2 = $('select[name="edit_unit_2"]').val();
    var position_3 = $('select[name="edit_unit_3"]').val();
    ...
    $prod_name_text = $prod_name + ' ( ' + temp_unit_name[position] + ', ' + unit_value_2 + ' X ' + unit_value_3 + ' )' + '<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button>';
