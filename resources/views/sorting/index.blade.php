    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{trans('file.Sorting List')}}</h3>
            </div>
            {!! Form::open(['route' => 'sortings.index', 'method' => 'get']) !!}
            <div class="row mb-3">
        ...
        @if(in_array("purchases-add", $all_permission))
            <!-- <a href="{{route('sortings.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Sorting')}}</a>&nbsp; -->
            <!-- <a href="{{url('sortings/sorting_by_csv')}}" class="btn btn-primary"><i class="dripicons-copy"></i> {{trans('file.Import Sorting')}}</a> -->
        @endif
    </div>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{trans('file.Sorting Details')}}</i>
                </div>
            </div>
        </div>
...
<div id="add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'sorting.add-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
...
<div id="edit-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'sorting.update-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{trans('file.Recieved Amount')}} *</label>
...
<script type="text/javascript">
    ...
    $(document).on("click", "table.purchase-list tbody .get-payment", function(event) {
        ...
        $.get('sortings/getpayment/' + id, function(data) {
                    ...
                    action: function ( e, dt, node, config ) {
                        if(user_verified == '1') {
                            ...
                            if(purchase_id.length && confirm("Are you sure want to delete?")) {
                                $.ajax({
                                    type:'POST',
                                    url:'sortings/deletebyselection',
                                    data:{
    ...
    function purchaseDetails(purchase){
        ...
        $.get('sortings/product_sorting/' + purchase[3], function(data){
