    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{trans('file.Caring List')}}</h3>
            </div>
            {!! Form::open(['route' => 'carings.index', 'method' => 'get']) !!}
            <div class="row mb-3">
        ...
        @if(in_array("purchases-add", $all_permission))
            <!-- <a href="{{route('carings.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Caring')}}</a>&nbsp; -->
            <!-- <a href="{{url('carings/caring_by_csv')}}" class="btn btn-primary"><i class="dripicons-copy"></i> {{trans('file.Import Caring')}}</a> -->
        @endif
    </div>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{trans('file.Caring Details')}}</i>
                </div>
            </div>
        </div>
...
<div id="add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'caring.add-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
...
<div id="edit-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'caring.update-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{trans('file.Recieved Amount')}} *</label>
...
<script type="text/javascript">
    ...
    $(document).on("click", "table.purchase-list tbody .get-payment", function(event) {
        ...
        $.get('carings/getpayment/' + id, function(data) {
    ...
    function purchaseDetails(purchase){
        ...
        $.get('carings/product_caring/' + purchase[3], function(data){
